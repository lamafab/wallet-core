...
use breez_sdk_core::{ReceivePaymentRequest, OpeningFeeParams};

pub fn receive_payment_reuest_from_proto(proto: Proto::ReceivePaymentRequest) -> Result<ReceivePaymentRequest> {
